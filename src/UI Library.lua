...
local themes = {
	...
	WeaponryPro = {
		...
		["Tab Background"] = Color3.fromRGB(20, 20, 20),
		["Tab Border"] = Color3.fromRGB(45, 45, 45),
		["Tab Toggle Background"] = Color3.fromRGB(30, 30, 30),
...
local library = utility.table({theme = table.clone(themes.WeaponryPro), folder = "weaponry.pro", extension = "cfg", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
...
function library:GetThemes()
	local themes = {"Default", "Midnight", "WeaponryPro"}
...
-- Edited by Exunys for weaponry.pro
